...
public class ObtentorDeComandosSemParametros {
	...
	public Method obterMetodoComandoSemParametrosDeComandoAdequado(Class<?> classeControladora, List<Method> metodos,
			ExpressaoUsuarioValores expressao) throws BlackStreenException {
		...
		this.verificadorListas.lancarErroComandoSeHouverMaisDeUmValor(poolMetodos, "Para o comando "
				+ expressao.getComando()
	...
	private void executarVerificacoesPoolMetodosSoValores(List<Method> poolMetodos, ExpressaoUsuarioValores expressao,
			Class<?> classeControladora) throws BlackStreenException {
		this.verificadorListas.lancarErroComandoSeEstiverVazia(poolMetodos,
				"Não existe comando que possa receber " + expressao.getValores().size()
						...
						+ classeControladora + "].");
		this.verificadorListas.lancarErroComandoSeHouverMaisDeUmValor(poolMetodos,
